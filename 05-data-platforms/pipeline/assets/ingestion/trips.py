...
# This bypasses the 'Cannot locate timezone' error on Windows
  for col in combined_df.select_dtypes(include=['datetime64', 'datetimetz']).columns:
    combined_df[col] = combined_df[col].astype(str)

  print(f"Final conversion to strings complete. Ready for ingestion.")
  return combined_df